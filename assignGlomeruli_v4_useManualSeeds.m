...
save(['intermediateAssignment_reprocessed_' savesuffix '.mat'], 'myOR', 'pubOR', 'shapePriorNorm', 'physDist', 'fullOdorRankCorr', 'odorRankCorr','pubPairwiseDistRank', 'rawClustersToDelete','slicesToRemove', 'pubNames', 'pubGlomNames','clusterfilename','clustersManuallyOmitted','omitAtlasZslices','minResponse','savesuffix','cX','cY','cZ','pubX','pubY','pubZ')

%% run assign glomeruli
clear all
nShuffles=10000;
intermediatefilename='intermediateAssignment_reprocessed_Volumes.mat';
